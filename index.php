	...
	<body>
		...
		<div class="container">
			...
			<div class="jumbotron">
				...
				<p class="lead">Something like an upgraded `EXPLAIN` command for browser. Highlights and explains MySQL queries. It also gives hints and links. Hope it will help</p>
